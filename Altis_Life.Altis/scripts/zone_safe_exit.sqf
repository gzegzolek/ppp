...
hint parseText format ["<t color='#5C87C7'><t size='2'><t align='center'>SafeZone<br/><br/><t color='#FFFFFF'><t align='center'><t size='1'>Bądź dzielny właśnie opuściłeś SafeZone"];
