...
_message = format["<img size='10' color='#FFFFFF' image='textures\civ\marke.paa'/><br/><br/><t size='2.5'>%1</t><br/><br/><t color='#f6f9fc' size='1.6'>Cywil</t>", name player];
