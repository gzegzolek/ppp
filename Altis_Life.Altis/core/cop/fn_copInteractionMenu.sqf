...
if(!isPlayer _curTarget) exitWith {hint "Celem nie jest Gracz"; closeDialog 0; };
if(side player == civilian) exitWith {hint "Zmien slot na cyw."; closeDialog 0;}; //Bad side check?
...
_bRemoveWeapon = _display displayCtrl 2408;
...
//Set Check Licenses Button
_bRemoveWeapon ctrlSetTooltip localize "STR_pInAct_RemoveWeapons";
_bRemoveWeapon buttonSetAction "[life_pInact_curTarget] spawn life_fnc_removeWeaponAction; closeDialog 0;";
