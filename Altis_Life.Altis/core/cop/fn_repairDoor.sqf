...
if(!(_building isKindOf "House_F")) exitWith {hint "Nie patrzysz na drzwi."};
_doors = 1;
...
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 1) exitWith {hint "Drzwi są już zamknięte"};
