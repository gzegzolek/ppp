...
//hint format["%1",_this];
hint parseText format["<t color='#FF0000'><t size='2'>%1</t></t><br/><t color='#FFD700'><t size='1.5'><br/>Nielegalne Przedmioty</t></t><br/>%2<br/><br/><br/><t color='#FF0000'>%3</t><br/><br/><t color='#FFD700'><t size='1.5'><br/>Wyposazenie:</t></t><br/><br/>Broń Główna: %4<br/>Broń Zapasowa: %5<br/>Kamizelka: %6<br/>Uniform: %7<br/><br/>"
,name _civ,_inv,if(_robber) then {"Obrabowal Bank"} else {""},_prim,_sec,_vest,_uni];
