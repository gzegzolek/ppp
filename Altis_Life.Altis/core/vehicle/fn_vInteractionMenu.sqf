...
*/
private["_display","_curTarget","_bRepair","_bRegister","_bSearch","_bPullOut","_bImpound","_bTowning","_bFlip","_bRemove"];
if(!dialog) then {
...
_display = findDisplay 37400;
	...
	_bRemove = _display displayCtrl 2409;
...
if(playerSide == west) then {
	...
	_bRemove ctrlSetTooltip localize "STR_vInAct_Remove";
	_bRemove buttonSetAction "closeDialog 0; [life_vInact_curTarget] spawn life_fnc_removeVehicle;";
