...
switch ( _coplevel ) do {
	case 1: { _rang = "Prywatny"; };
	case 2: { _rang = "Kapral"; };
	case 3: { _rang = "Sierżant"; };
	case 4: { _rang = "Porucznik"; };
	case 5: { _rang = "Kapitan"; };
	case 6: { _rang = "Major"; };
	default { _rang = "Ochrona";};
};

_message = format["<img size='10' color='#FFFFFF' image='textures\ASF\rank.jpg'/><br/><br/><t size='2.5'>%1</t><br/><t size='1.8'>%2</t><br/><br/><t color='#336699' size='1.6'>Siły Bezpieczeństwa Altis</t>", name player, _rang];
