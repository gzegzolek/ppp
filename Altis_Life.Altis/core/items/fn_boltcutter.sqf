...
if(!(_building isKindOf "House_F")) exitWith {hint "Nie patrzysz na drzwi domu."};

if(((nearestObject [[16572.674,12733.395,0],"Land_Dome_Small_F"]) == _building) && ((west countSide playableUnits) < 5)) exitWith {hint localize "STR_Civ_NotEnoughCops";};
