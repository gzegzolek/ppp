...
if(life_interrupted) exitWith {life_interrupted = false; titleText["Akcja Anulowana","PLAIN"]; life_action_inUse = false;};


life_action_inUse = false;
_vault setVariable["chargeplaced",false,true];
life_atmcash = life_atmcash + 50000;
hint parseText format["Za rozbrojenie bomby otrzymałeś $50000."];
