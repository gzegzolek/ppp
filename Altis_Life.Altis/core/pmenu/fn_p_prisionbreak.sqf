...
if(player distance _shop > 2) exitWith {hint format ["Musisz stać bliżej!"];};

createDialog "life_prision_list";
_display = findDisplay 8100;
_list = _display displayCtrl 8101;
lbClear _list;
ctrlSetText[8104,"Hackuje System..."];
_list = _display displayctrl 8101;
_units = [];
{
...
ctrlSetText[8104,"Łączy z systemem..."];
if(((lbSize _list)-1) == -1) then
{
	_list lbAdd "Brak więzniów...";
};