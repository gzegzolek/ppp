...
if(isNil "_data") exitWith {hint "Błąd przy pobieraniu przestępców.";};
if(typeName _data != "ARRAY") exitWith {hint "Błąd przy pobieraniu przestępców.";};
if(count _data == 0) exitWith {hint "Błąd przy pobieraniu przestępców.";};
lbClear _list;
