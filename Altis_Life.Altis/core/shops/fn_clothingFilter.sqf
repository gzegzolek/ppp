...
_clothes = switch (life_clothing_store) do
{
	...
	case "donator1": {[_selection] call life_fnc_clothing_donator1;};
	case "donator2": {[_selection] call life_fnc_clothing_donator2;};
	case "donator3": {[_selection] call life_fnc_clothing_donator3;};
