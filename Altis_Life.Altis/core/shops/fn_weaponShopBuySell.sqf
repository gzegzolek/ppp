...
if((uiNamespace getVariable["Weapon_Shop_Filter",0]) == 1) then
{
	...
	_toLog = format ["0|%1 (%2) has the Item %3 for %4 sold", name player, getPlayerUID player, _itemInfo, [_price] call life_fnc_numberText];
	[[_toLog],"Arma3Log"] spawn life_fnc_MP;	
}
	else
{
	private["_hideout"];
