...
//Virtual Inventory Items
	...
	case "life_inv_kidney": {"Nerka"};
	case "life_inv_gagkit": {"Knebel"};
	case "life_inv_ptools": {"Dekoder"};
	
	//License Block
	case "license_civ_donator": {"Licencja na Donatora"};
	case "license_civ_donator1": {"Donator Poziom 1"};
	case "license_civ_donator2": {"Donator Poziom 2"};
	case "license_civ_donator3": {"Donator Poziom 3"};
