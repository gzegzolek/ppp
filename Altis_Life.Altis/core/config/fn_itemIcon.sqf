...
switch (_var) do
{
	...
	case "life_inv_tabakip": {("icons\items\cygaro.paa")};
	...
	case "life_inv_tabakp": {("icons\items\papieros.paa")};
	...
	case "life_inv_uran1": {("icons\items\uran1.paa")};
	case "life_inv_uran2": {("icons\items\uran2.paa")};
	case "life_inv_uran3": {("icons\items\uran3.paa")};
	case "life_inv_uran4": {("icons\items\uran4.paa")};
	case "life_inv_uran5": {("icons\items\brennstab.paa")};
	case "life_inv_uranip": {("icons\items\uranip.paa")};
	case "life_inv_baumwollep": {("icons\items\baumwolle.paa")};
	case "life_inv_skalpel": {("icons\items\skalpel.paa")};
