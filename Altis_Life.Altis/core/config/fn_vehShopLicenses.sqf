...
switch (life_veh_shop select 0) do
{
	...
	case "donator1": {_ret = license_civ_donator1;};
	case "donator2": {_ret = license_civ_donator2;};
	case "donator3": {_ret = license_civ_donator3;};
	case "don_car": {_ret = license_civ_driver;};
	case "don_truck": {_ret = license_civ_truck;};
	case "don_air": {_ret = license_civ_air;};
