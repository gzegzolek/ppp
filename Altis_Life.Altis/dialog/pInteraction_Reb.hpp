...
class pInteraction_Reb
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Akcja ...</t>"; //--- ToDo: Localize;
	...
	class controls
	{
		...
		{
			idc = 2407;
			text = "Zobacz Licencje"; //--- ToDo: Localize;
			x = 16 * GUI_GRID_W + GUI_GRID_X;
			y = 13 * GUI_GRID_H + GUI_GRID_Y;
			w = 4 * GUI_GRID_W;
			h = 3 * GUI_GRID_H;
