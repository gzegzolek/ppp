class Evga_gambling {
	...
	class controls {
		...
		class GambleButton2 : life_RscButtonMenu {
			idc = -1;
			text = "Slotmachine";
            onButtonClick = "['einarmiger Bandit'] call EVGA_fnc_gambling";
		...
		class GambleButton1 : life_RscButtonMenu {
			idc = -1;
			text = "Würfeln";
            onButtonClick = "['Dice'] call EVGA_fnc_gambling";
        ...
        class GamblingDiceView : Life_RscControlsGroup
        {
            ...
            class Controls
            {
                ...
                */
                ...
                {
                    idc = 5101;
                    text = "<img size='2.5' image='core\EVGA\icons\metal_steel1.paa'/>";
                ...
                class GambleButtonDice : life_RscButtonMenu
                {
                    idc = 5105;
                    text = "würfeln...";
                    onButtonClick = "ctrlEnable[5105, false];[] spawn EVGA_fnc_gamble_dice;[] spawn {sleep(1);ctrlEnable[5105, true];};";
                    x = 0.07;
                    y = 0.375;
                    w = (6.25 / 40);
                    h = (1 / 25);
        ...
        class GamblingBanditView : Life_RscControlsGroup
        {
            ...
            class Controls
            {
                ...
                class GambleButtonBandit : life_RscButtonMenu
                {
                    idc = 5206;
                    text = "spielen...";
                    onButtonClick = "ctrlEnable[5206, false];[] spawn EVGA_fnc_gamble_bandit;[] spawn {sleep(1);ctrlEnable[5206, true];};";
                    x = 0.07;
                    y = 0.375;
                    w = (6.25 / 40);
                    h = (1 / 25);
