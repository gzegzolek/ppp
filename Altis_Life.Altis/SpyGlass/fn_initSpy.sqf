...
#define SPY "spy_log"
// AKI :: Poprawiono dwa następne wiersze. Dodano "true" oraz "then".
exitWith {true};
if (isServer && !hasInterface) then exitWith {true}; //Server doesn't need to know.
